\section{Análise teórica do passa-baixas}\label{sec:analise-teorica-do-passa-baixas}
  ...
  \begin{figure}[H]
    ...
    \descrfigure[Fonte]{Elaboração Própria (\the\year)}%
    \descrfigure[Nota]{Desenvolvido no programa Kicad}
  ...
  \begin{figure}[H]
    ...
    \end{subfigure}
    \descrfigure{Elaboração Própria (\the\year)}
